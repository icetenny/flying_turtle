...
dW, dH, d = calculate_real_distance(
    px1, py1, px2, py2, width2height_ratio, resolution, known_distance)
print(
    f"The real-life distance between the points is: {dW:.2f}, {dH:.2f}, {d:.2f} units")
